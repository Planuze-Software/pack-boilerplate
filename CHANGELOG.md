...
- Document one provider-neutral central scan contract for GitHub, GitLab and
  Bitbucket releases.
- Pin the authoring and provider-neutral release CLI to `0.4.7` and the GitHub
  inline job to the immutable H2 public runner action.
...
- Align the CLI reference and release instructions with `pack-publisher` 0.4.7,
